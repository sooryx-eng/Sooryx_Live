      ...
      <div className="mx-auto max-w-2xl">
        ...
        >
          ...
          <p className="mb-8 text-center text-lg text-slate-600">
            Thanks for taking the first step toward shared solar ownership. We’ve reserved your place in the BillShield early-access list.
          </p>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-amber-900">Your place in shared solar</h2>
            </div>
            <p className="text-lg text-amber-900 font-bold mb-2">
              A first look at the next BillShield cohort
            </p>
            <p className="text-sm text-amber-800">
              When the cohort opens, you’ll be able to review the solar asset, understand the SPV structure, and explore becoming an equity owner with a share of generated income.
            </p>
          </motion.div>
          ...
          >
            <h3 className="font-bold text-slate-900">Here’s what happens next</h3>
            <div className="space-y-3">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-slate-900">We shape the opportunity</p>
                  <p className="text-sm text-slate-600">Preparing the SPV and the solar asset behind the cohort</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-slate-900">You get an early look</p>
                  <p className="text-sm text-slate-600">Review the asset and offering before the cohort opens</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-slate-900">Choose your next step</p>
                  <p className="text-sm text-slate-600">Decide whether the opportunity is right for you</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="rounded-lg bg-emerald-50 p-4">
              <p className="text-sm font-semibold text-emerald-700">✓ First look at the cohort</p>
            </div>
            <div className="rounded-lg bg-emerald-50 p-4">
