      ...
      <div className="mx-auto max-w-2xl">
        ...
        >
          ...
          <p className="mb-8 text-center text-lg text-slate-600">
            Thank you for expressing interest in BillShield. Your place in the early-access cohort is reserved.
          </p>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-amber-900">Your Cohort Interest</h2>
            </div>
            <p className="text-lg text-amber-900 font-bold mb-2">
              Participation in a solar SPV cohort
            </p>
            <p className="text-sm text-amber-800">
              When the offering opens, eligible participants can become equity owners in the SPV holding the solar asset and receive their share of generated income under the offering terms.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-slate-900">We prepare the solar cohort</p>
                  <p className="text-sm text-slate-600">Structuring the SPV and its underlying solar asset</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-slate-900">Cohort access opens</p>
                  <p className="text-sm text-slate-600">You will be among the first to review the offering</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-slate-900">Participate in solar income</p>
                  <p className="text-sm text-slate-600">Receive your share of income generated by the solar asset</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="rounded-lg bg-emerald-50 p-4">
              <p className="text-sm font-semibold text-emerald-700">✓ Cohort information first</p>
            </div>
            <div className="rounded-lg bg-emerald-50 p-4">
