...
export default function BillShieldSignup() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      initMsg91Widget('', 'msg91-captcha-signup')
        .then(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-amber-50/30 to-emerald-50/30 px-4 py-8 md:py-16">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-slate-600">Be among the first to explore a simpler, more connected way to participate in solar ownership.</p>
        <motion.div 
        ...
        >
          ☀️ Get early access to the next solar cohort
        </motion.div>
      </div>
      ...
      <div className="mx-auto max-w-sm">
        ...
        >
          <div className="rounded-2xl bg-gradient-to-br from-amber-50/70 to-yellow-50/70 p-4 backdrop-blur">
            ...
            <p className="text-sm text-slate-600">A simpler way to participate in solar ownership</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-emerald-50/70 to-green-50/70 p-4 backdrop-blur">
            ...
            <p className="text-sm text-slate-600">See the opportunity before you decide</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-blue-50/70 to-cyan-50/70 p-4 backdrop-blur">
            ...
            <p className="text-sm text-slate-600">Share in income generated by the asset</p>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-purple-50/70 to-pink-50/70 p-4 backdrop-blur">
            ...
            <p className="text-sm text-slate-600">Own a share without installing a solar plant</p>
          </div>
        </motion.div>
      </div>
    </div>
