      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">Track your cohort participation, SPV ownership, and solar income updates from one place.</p>
          </div>
          <button
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-slate-600">SPV Participation</p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-lg">
            ...
            <p className="mb-4 text-sm text-slate-600">Your cohort&apos;s SPV and underlying solar asset details will appear here.</p>
          ...
          <div className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-lg">
            ...
            <p className="mb-4 text-sm text-slate-600">Track income generated by the solar asset and your share under the offering terms.</p>
