    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-amber-50/30 to-emerald-50/30 px-4 py-16">
        <div className="mx-auto max-w-xl rounded-3xl border border-slate-200/70 bg-white/90 p-8 text-center shadow-2xl backdrop-blur">
          ...
          <p className="mt-3 text-slate-600">Please sign in to access your BillShield cohort profile.</p>
          <Link
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-amber-50/30 to-emerald-50/30 px-4 py-8 md:py-14">
      <div className="mx-auto max-w-5xl">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-amber-600">BillShield Cohort Profile</p>
            <h1 className="text-3xl font-bold text-slate-900 md:text-4xl">Hi, {user.name}</h1>
            <p className="mt-2 text-sm text-slate-600">Your home for cohort updates, SPV ownership details, and the solar story behind your participation.</p>
          </div>
          <button
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-slate-600">Your solar participation</p>
              <p className="text-3xl font-black text-slate-900">On the way</p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-lg">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="text-xl font-bold text-slate-900">Solar Asset</h2>
            </div>
              <p className="mb-4 text-sm text-slate-600">Your cohort&apos;s SPV and the solar asset behind it will appear here.</p>
          ...
          <div className="rounded-3xl border border-slate-200/80 bg-white/95 p-6 shadow-lg">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h2 className="text-xl font-bold text-slate-900">Income Participation</h2>
            </div>
              <p className="mb-4 text-sm text-slate-600">Follow the income story of the solar asset and your share under the offering.</p>
