      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-16 pt-44 md:px-10 md:pt-40">
        ...
        >
          ...
          >
            ...
            Own a Share of Solar Infrastructure
          </motion.div>
          ...
          <GlowingHeader as="h1" className="mx-auto mb-6 max-w-4xl text-5xl font-bold leading-tight tracking-tight md:text-6xl lg:text-7xl">
            ...
            Without Owning a Rooftop.
            </span>
          </GlowingHeader>

          <p className="mx-auto max-w-3xl text-lg text-slate-600 md:text-xl">
            Join a BillShield cohort and become an equity owner in the special purpose vehicle (SPV) that holds the solar asset. 
            Receive your share of the income generated by that asset, without installing or maintaining a solar plant yourself.
          </p>
          ...
          >
            <p className="text-lg font-semibold text-slate-700">
              BillShield is coming soon.
            </p>
            <p className="mt-3 text-sm text-slate-600">
              We are preparing the first cohort for a simple, transparent way to participate in solar ownership and income.
            </p>
          </motion.div>
      ...
      <section className="mx-auto max-w-7xl border-y border-slate-200/70 px-6 py-20 md:px-10">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <StepCard
            ...
            title="Join a Cohort"
            description="Choose a BillShield solar cohort and participate in the SPV created for its solar asset."
            color="amber"
          />
          <StepCard
            step="2"
            icon={<Layers className="size-8" />}
            title="Own Equity in the SPV"
            description="Your cohort participation gives you an equity interest in the SPV that holds the solar asset."
            color="yellow"
          />
          <StepCard
            step="3"
            icon={<TrendingUp className="size-8" />}
            title="Receive Your Share of Income"
            description="As the asset generates income, you receive your proportionate share according to the offering terms."
            color="emerald"
          />
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl border-t border-slate-200/70 px-6 py-20 md:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <FeatureCard
            ...
            title="Own Without Installation"
            description="Participate in a solar asset without arranging a rooftop, equipment, or ongoing maintenance."
            color="amber"
          />
          <FeatureCard
            icon={<TrendingUp className="size-7" />}
            title="Asset-Backed Participation"
            description="Your equity interest is connected to a solar asset held by the cohort's SPV."
            color="yellow"
          />
          <FeatureCard
            icon={<Zap className="size-7" />}
            title="Share in Solar Income"
            description="Benefit from income generated by the solar asset in proportion to your ownership interest."
            color="emerald"
          />
          <FeatureCard
            icon={<Star className="size-7" />}
            title="Transparent Structure"
            description="Understand the cohort, the SPV, the underlying solar asset, and how income is shared."
            color="blue"
          />
          <FeatureCard
            icon={<CheckCircle2 className="size-7" />}
            title="Built Around a Cohort"
            description="Each cohort participates in a defined SPV and the solar asset held by that SPV."
            color="purple"
          />
          <FeatureCard
            icon={<Layers className="size-7" />}
            title="Digital Access"
            description="Access your participation details and updates online as the BillShield experience becomes available."
            color="green"
          />
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl border-t border-slate-200/70 px-6 py-20 md:px-10">
        ...
        <div className="space-y-4">
          <FAQCard
            ...
            answer="When you join a cohort, you become an equity owner in the SPV created to hold that cohort's solar asset. Your ownership interest is defined by the applicable offering terms."
          />
          <FAQCard
            question="How do I earn income?"
            answer="The solar asset generates income through its operations. Your cohort's SPV distributes your proportionate share according to the applicable offering and distribution terms."
          />
          <FAQCard
          ...
          <FAQCard
            ...
            answer="A cohort is a group of participants associated with a specific solar asset and its SPV. The cohort's ownership and income participation are set out in the offering documents."
          />
          <FAQCard
            question="How is income shared?"
            answer="Income generated by the solar asset is shared among the SPV's equity owners in proportion to their ownership interest, subject to operating costs and the applicable offering terms."
          />
        </div>
      </section>
